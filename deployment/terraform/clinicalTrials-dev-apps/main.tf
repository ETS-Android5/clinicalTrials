...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/clinicalTrials-dev-networks/regions/us-central1/subnetworks/clinicalTrials-dev-gke-subnet",
  ]
  activate_apis = [
...
module "clinicalTrials_dev" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "clinicalTrials-dev"
  project_id = module.project.project_id
  domain     = "clinicalTrials-dev.clinicaltrials.one."
  type       = "public"
...
module "clinicalTrials_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "clinicalTrials-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "clinicalTrials-dev-networks"

  network                 = "clinicalTrials-dev-network"
  subnetwork              = "clinicalTrials-dev-gke-subnet"
  ip_range_pods           = "clinicalTrials-dev-pods-range"
  ip_range_services       = "clinicalTrials-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@clinicalTrials-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
