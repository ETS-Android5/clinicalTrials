...
terraform {
  ...
  backend "gcs" {
    bucket = "judealexis-clinicalstudies-dev-terraform-state"
    prefix = "judealexis-clinicalstudies-dev-apps"
  }
}

# Reserve a static external IP for the Ingress.
resource "google_compute_global_address" "ingress_static_ip" {
  name         = "judealexis-clinicalstudies-dev-ingress-ip"
...
#7#
#7#   github {
#7#     owner = "JudeAlexis111"
#7#     name  = "clinicalTrials"
#7#     push { branch = "^develop$" }
#7#   }
...
module "project" {
  ...
  name                    = "judealexis-clinicalstudies-dev-apps"
  org_id                  = ""
  folder_id               = "444565693245"
  billing_account         = "0103E1-E9BF45-92AA9E"
  lien                    = true
  default_service_account = "keep"
  skip_gcloud_download    = true
  shared_vpc              = "judealexis-clinicalstudies-dev-networks"
  shared_vpc_subnets = [
    "projects/judealexis-clinicalstudies-dev-networks/regions/us-central1/subnetworks/judealexis-clinicalstudies-dev-gke-subnet",
  ]
  activate_apis = [
...
module "judealexis_clinicalstudies_dev" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "judealexis-clinicalstudies-dev"
  project_id = module.project.project_id
  domain     = "judealexis-clinicalstudies-dev.clinicaltrials.one."
  type       = "public"
...
module "judealexis_clinicalstudies_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "judealexis-clinicalstudies-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "judealexis-clinicalstudies-dev-networks"

  network                 = "judealexis-clinicalstudies-dev-network"
  subnetwork              = "judealexis-clinicalstudies-dev-gke-subnet"
  ip_range_pods           = "judealexis-clinicalstudies-dev-pods-range"
  ip_range_services       = "judealexis-clinicalstudies-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@judealexis-clinicalstudies-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
