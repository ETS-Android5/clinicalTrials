...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "clinicaltrials-dev-firebase"
  }
}
...
module "project" {
  ...
  name                    = "clinicaltrials-dev-firebase"
  org_id                  = ""
...
module "clinicaltrials_dev_mystudies_firestore_raw_data" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "clinicaltrials-dev-mystudies-firestore-raw-data"
  project_id = module.project.project_id
