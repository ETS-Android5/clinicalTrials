...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "judealexis-studies-dev-firebase"
  }
}
...
module "project" {
  ...
  name                    = "judealexis-studies-dev-firebase"
  org_id                  = ""
...
module "judealexis_studies_dev_mystudies_firestore_raw_data" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "judealexis-studies-dev-mystudies-firestore-raw-data"
  project_id = module.project.project_id
