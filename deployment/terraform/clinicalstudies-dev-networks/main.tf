...
module "bastion_vm" {
  ...
  network      = module.clinicalstudies_dev_network.network.network.self_link
  subnet       = module.clinicalstudies_dev_network.subnets["us-central1/clinicalstudies-dev-bastion-subnet"].self_link
  members      = ["group:clinicalstudies-dev-bastion-accessors@clinicaltrials.one"]
  ...
  nats = [
    {
      ...
      subnetworks = [
        {
          name                     = "${module.clinicalstudies_dev_network.subnets["us-central1/clinicalstudies-dev-bastion-subnet"].self_link}"
          source_ip_ranges_to_nat  = ["PRIMARY_IP_RANGE"]
          secondary_ip_range_names = []
        },
        {
          name                     = "${module.clinicalstudies_dev_network.subnets["us-central1/clinicalstudies-dev-gke-subnet"].self_link}"
