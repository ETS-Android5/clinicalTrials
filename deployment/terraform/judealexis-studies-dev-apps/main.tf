...
terraform {
  ...
  backend "gcs" {
    bucket = "judealexis-studies-dev-terraform-state"
    prefix = "judealexis-studies-dev-apps"
  }
}

# Reserve a static external IP for the Ingress.
resource "google_compute_global_address" "ingress_static_ip" {
  name         = "judealexis-studies-dev-ingress-ip"
...
module "project" {
  ...
  name                    = "judealexis-studies-dev-apps"
  org_id                  = ""
  ...
  shared_vpc              = "judealexis-studies-dev-networks"
  shared_vpc_subnets = [
    "projects/judealexis-studies-dev-networks/regions/us-central1/subnetworks/judealexis-studies-dev-gke-subnet",
  ]
  activate_apis = [
...
module "judealexis_studies_dev" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "judealexis-studies-dev"
  project_id = module.project.project_id
  domain     = "judealexis-studies-dev.clinicaltrials.one."
  type       = "public"
...
module "judealexis_studies_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "judealexis-studies-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "judealexis-studies-dev-networks"

  network                 = "judealexis-studies-dev-network"
  subnetwork              = "judealexis-studies-dev-gke-subnet"
  ip_range_pods           = "judealexis-studies-dev-pods-range"
  ip_range_services       = "judealexis-studies-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@judealexis-studies-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
