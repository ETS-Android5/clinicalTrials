...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "judealexis-clinicalstudies-dev-firebase"
  }
}
...
module "project" {
  ...
  name                    = "judealexis-clinicalstudies-dev-firebase"
  org_id                  = ""
...
module "judealexis_clinicalstudies_dev_mystudies_firestore_raw_data" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "judealexis-clinicalstudies-dev-mystudies-firestore-raw-data"
  project_id = module.project.project_id
